...
public class buyingticket extends AppCompatActivity {
    ...
    private int year,month,day,y,m,d;
       ...
       final TextView tx4=(TextView)findViewById(R.id.textView4);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(buyingticket.this, 0,listener,year,month-1,day+1);//后边三个参数为显示dialog时默认的日期，月份从0开始，0-11对应1-12个月
                dialog.show();
     ...
     //查询按钮
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int nyear=ncal.get(Calendar.YEAR);       //获取年月日时分秒
                int nmonth=ncal.get(Calendar.MONTH)+1;   //获取到的月份是从0开始计数
                int nday=ncal.get(Calendar.DAY_OF_MONTH);
                if(y<nday||(y==nyear&&m<nmonth)||(y==nyear&&m==nmonth&&d<=nday)){
                    Toast.makeText(buyingticket.this, "日期不能等于或早于当前日期", Toast.LENGTH_SHORT).show();
                }
                else if(begin==dest)
                {
                    Date date = new Date();
